        ...
        <section className="main-what-section">
            ...
            <div className="main-what-cards">
                <div className="what-card">
                    <img src="https://images.pexels.com/photos/56832/road-asphalt-space-sky-56832.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="Road Photo" />
                <p>Plot, plan, and scope out potential dates to reach new fans!</p>
                </div>
                <div className="what-card">
                <img src="https://images.pexels.com/photos/1105666/pexels-photo-1105666.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Concert Photo" />
            <p>Keep records of your financial earnings for each show, so you can budget for expenses on the next one!</p>
                </div>
                <div className="what-card">
                <img src="https://images.pexels.com/photos/1751731/pexels-photo-1751731.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="Concert Photo" />
