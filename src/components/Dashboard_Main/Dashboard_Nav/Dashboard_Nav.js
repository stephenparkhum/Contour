        ...
        return ( 
            ...
            <nav className="dashboard-nav">
                <ul>
                    ...
                    <li className="add-btn"><NavLink to="/dashboard/add-show" activeClassName="dashboard-add-active">Add Show +</NavLink></li>
                    <li className="add-btn"><NavLink to="/dashboard/add-tour" activeClassName="dashboard-add-active">Add Tour +</NavLink></li>
                </ul>
            </nav>
            </>
         );
